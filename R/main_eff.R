...
#' @param xj Integer indexing the main effect of what elements of \eqn{x} to be found.  If a vector is supplied the marginal main effect of each element is calculated sequentially.  The integers supplied in \code{xj} are equivalent to the indicies of the columns in \code{rangex}.
...
#'
#' BMB_example <- BMB(X = X, y = y, cov.structure = "indep", BTE = c(100,3000,1), lml = FALSE)
#'
